...
\code{k=5} gives the historical $\cxor$ instance.  This listing, the historical implementation,
and the harnesses of Appendix~\ref{sec:verification-new} are all contained in the paper's
repository~\cite{cxorrepo}.
...
The historical \code{cta.py} of~\cite{cxorrepo} uses a \code{bitarray} table and performs the $\W5$ assignment only
