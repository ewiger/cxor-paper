...
in \code{cta\_spec.py}~\cite{cxorrepo} nevertheless checks the implementation against the main
claims.  Running
...
The separate \code{cta\_w5\_w6.py} harness of the same repository reproduces the reference 33-bit example, compares the
